...
| ProgramBench-style file/project output | Prefer `workspace-archive@1` for an isolated project tree | Contracts are ready for a narrow adapter; no ProgramBench adapter is claimed |
...
- general ProgramBench or Terminal-Bench support;
