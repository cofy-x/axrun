...
def _offline_script(source: str, branch: str) -> str:
    ...
    commands = {
        "e592c32aec70": ("pip install pytest pytest-timeout pytest-xdist -q 2>/dev/null || true",),
        "5d974fdda794": ("pip install pytest pytest-timeout pytest-xdist -q 2>/dev/null || true",),
    }.get(branch)
    if commands is None:
